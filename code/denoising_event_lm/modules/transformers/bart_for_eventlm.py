...
from transformers import BartForConditionalGeneration, GPT2LMHeadModel, PretrainedBartModel, BartConfig, BartModel
...
class BartForConditionalGeneration_for_EventLM(PretrainedBartModel):
    ...
    def generate(
        ...
        **model_specific_kwargs
        ...
        assert (
            bad_verbs_ids is None or isinstance(bad_verbs_ids, list) and (len(bad_verbs_ids) == 0 or isinstance(bad_verbs_ids[0], list))
...
class GPTForConditionalGeneration_for_EventLM(GPT2LMHeadModel):
    def forward(
            self,
            input_ids,
            attention_mask=None,
